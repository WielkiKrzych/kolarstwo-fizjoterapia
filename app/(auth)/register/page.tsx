...
import { Bike, Activity, User, Mail, Lock, Phone, ArrowRight, Loader2, CheckCircle2 } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Zarejestruj się, aby rozpocząć współpracę
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                Akceptuję{" "}
                <Link href={"/regulamin" as any} className="text-primary-600 hover:text-primary-700">
                  regulamin
                </Link>
                {" "}i{" "}
                <Link href={"/polityka-prywatnosci" as any} className="text-primary-600 hover:text-primary-700">
